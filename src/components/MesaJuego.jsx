  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: 'url(/images/ursol.png)',
      ...
      <motion.div
        style={{
          ...
          backgroundImage: 'url(/images/cartas/cartacubierta.png)',
      ...
      <div style={{
        ...
        backgroundImage: 'url(/images/fichas_crupier.png)',
        backgroundSize: 'contain',
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center'
      }} />
      ...
      <div style={{
        ...
        backgroundImage: 'url(/images/apuesto.png)',
        backgroundSize: 'contain',
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center'
      }} />
